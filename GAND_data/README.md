...
The full GAND dataset of 5000+ instances (split into a training, test, and development set) is made available on Hugging Face: <https://huggingface.co/datasets/jhacken/GAND>.
